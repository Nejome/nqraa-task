        ...
        <div class="container mx-auto">
            <div class="px-4 py-5">
                <divl class="flex flex-col xl:flex-row justify-between">
                    <h1 class="text-xl text-[#34384d]">تعديل المستخدم</h1>
        ...
        <div class="container mx-auto">
            <div class="px-4 py-2">
                <div class="bg-white border rounded-2xl px-6 py-6">
                    <form method="post" action="/users/{{$user->id}}}}" class="mt-10">
                        @csrf
                        @method('put')
                        ...
                        <div class="grid grid-cols-6 gap-4">
                            <div class="col-span-6 sm:col-span-3 mt-3">
                                ...
                                <input type="text" name="name" value="{{old('name', $user->name)}}" class="bg-[#f8f9fb] rounded px-3 py-2 w-full mt-1 border">
                                <p class="text-red-600">{{$errors->first('name')}}</p>
                            </div>
                            <div class="col-span-6 sm:col-span-3 mt-3">
                                <label class="text-[#626475] text-sm">البريد الإلكتروني</label>
                                <input type="email" name="email" value="{{old('email', $user->email)}}" class="bg-[#f8f9fb] rounded px-3 py-2 w-full mt-1 border">
                                <p class="text-red-600">{{$errors->first('email')}}</p>
                            </div>
                            <div class="col-span-6 sm:col-span-3 mt-3">
                                <label class="text-[#626475] text-sm">الوظيفة</label>
                                <input type="text" name="job" value="{{old('job', $user->job)}}" class="bg-[#f8f9fb] rounded px-3 py-2 w-full mt-1 border">
                                <p class="text-red-600">{{$errors->first('job')}}</p>
                            </div>
                            <div class="col-span-6 sm:col-span-3 mt-3">
                                <label class="text-[#626475] text-sm">قسم الوظيفة</label>
                                <input type="text" name="job_department" value="{{old('job_department', $user->job_department)}}" class="bg-[#f8f9fb] rounded px-3 py-2 w-full mt-1 border">
                                <p class="text-red-600">{{$errors->first('job_department')}}</p>
                            </div>
                            <div class="col-span-6 sm:col-span-3 mt-3">
                                <label class="text-[#626475] text-sm">رقم الجوال</label>
                                <input type="text" name="phone" value="{{old('phone', $user->phone)}}" class="bg-[#f8f9fb] rounded px-3 py-2 w-full mt-1 border">
                            ...
                            <div class="col-span-6 sm:col-span-3 mt-3">
                                <label class="text-[#626475] text-sm">كلمة المرور (اختياري)</label>
                        ...
                        <div class="mt-10 text-center">
                            <button type="submit" class="bg-indigo-700 hover:bg-indigo-600 text-white px-3 py-2 rounded text-sm">تعديل</button>
                        </div>
                    </form>
                </div>
            </div>
